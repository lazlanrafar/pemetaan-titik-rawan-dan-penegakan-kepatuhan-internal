<!-- Modal -->
<div class="modal fade" id="formUpdatePerilaku{{ $item->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="is_pelanggaran" class="form-control">
                                    <option value="true" @if ($item->is_pelanggaran) selected @endif>Ya</option>
                                    <option value="false" @if (!$item->is_pelanggaran) selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="is_penghargaan" class="form-control">
                                    <option value="true" @if ($item->is_penghargaan) selected @endif>Ya</option>
                                    <option value="false" @if (!$item->is_penghargaan) selected @endif>Tidak
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
